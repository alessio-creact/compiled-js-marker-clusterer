...
var _marker = require('../../../core/directives/marker');

var _googleMapsApiWrapper = require('../../../core/services/google-maps-api-wrapper');

var _clusterManager = require('./cluster-manager');
...
describe('ClusterManager', function () {
    ...
    describe('Create a new marker', function () {
        it('should call the mapsApiWrapper when creating a new marker', (0, _testing.inject)([_clusterManager.ClusterManager, _googleMapsApiWrapper.GoogleMapsAPIWrapper], function (clusterManager, apiWrapper) {
            var newMarker = new _marker.AgmMarker(clusterManager);
    ...
    describe('Delete a marker', function () {
        it('should set the map to null when deleting a existing marker', (0, _testing.inject)([_clusterManager.ClusterManager, _googleMapsApiWrapper.GoogleMapsAPIWrapper], function (clusterManager, apiWrapper) {
            var newMarker = new _marker.AgmMarker(clusterManager);
            newMarker.latitude = 34.4;
            newMarker.longitude = 22.3;
            newMarker.label = 'A';
    ...
    describe('set marker icon', function () {
        it('should update that marker via setIcon method when the markerUrl changes', (0, _testing.async)((0, _testing.inject)([_clusterManager.ClusterManager, _googleMapsApiWrapper.GoogleMapsAPIWrapper], function (markerManager, apiWrapper) {
    ...
    describe('set marker opacity', function () {
        it('should update that marker via setOpacity method when the markerOpacity changes', (0, _testing.async)((0, _testing.inject)([_clusterManager.ClusterManager, _googleMapsApiWrapper.GoogleMapsAPIWrapper], function (markerManager, apiWrapper) {
            var newMarker = new _marker.AgmMarker(markerManager);
            newMarker.latitude = 34.4;
            newMarker.longitude = 22.3;
            newMarker.label = 'A';
    ...
    describe('set visible option', function () {
        it('should update that marker via setVisible method when the visible changes', (0, _testing.async)((0, _testing.inject)([_clusterManager.ClusterManager, _googleMapsApiWrapper.GoogleMapsAPIWrapper], function (markerManager, apiWrapper) {
            var newMarker = new _marker.AgmMarker(markerManager);
            newMarker.latitude = 34.4;
            newMarker.longitude = 22.3;
            newMarker.label = 'A';
    ...
    describe('set zIndex option', function () {
        it('should update that marker via setZIndex method when the zIndex changes', (0, _testing.async)((0, _testing.inject)([_clusterManager.ClusterManager, _googleMapsApiWrapper.GoogleMapsAPIWrapper], function (markerManager, apiWrapper) {
            var newMarker = new _marker.AgmMarker(markerManager);
            newMarker.latitude = 34.4;
            newMarker.longitude = 22.3;
            newMarker.label = 'A';
